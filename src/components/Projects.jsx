...
const projects = [
  {
    title: `Expense Tracker (Free Local MVP)`,
    description: `A personal expense tracking application built with Vite, TypeScript, and Node.js. The app allows you to log expenses via a simple message format (e.g., "food 250 chai") with natural language parsing, and stores data in SQLite (local) or Postgres (hosting). It features expense categorization, real-time summaries, and WhatsApp webhook integration for easy logging. Built with Claude and GitHub Copilot for rapid development. I use this daily for managing my personal expenses—simple, free, and powerful.`,
    imageUrl: expenseTrackerImage,
    link: 'https://ayush-expense-tracker.vercel.app/',
  },
  {
